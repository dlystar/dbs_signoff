...
const Submit = ({
  ...
  const handleSubmit = (resolve) => {
    ...
    getValue((params) => {
      ...
      const reloadFormFieldLinkageFn = () => {
        eventManager.emit(`on-reload-form-field-linkage-${orderContainerID}`)
      }
      ...
      const createSubmitHandler = () => {
        ...
        return () => {
          ...
          if (submitType) {
            ...
            submitAction(submitParams, successCallBack, dbsAiRequestError, resolve, reloadFormFieldLinkageFn);
          }
        };
      };
